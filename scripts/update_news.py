...
_CLASSIFY_SYSTEM = (
    ...
    "- 科技：技术发布、产品上线、模型能力、工具更新、技术架构、应用落地\n"
    "- 学术：论文、实验结果、数据集、基准测试、学术会议、理论研究\n"
    "- 金融：融资、收购、估值、股价、IPO、商业合作、市场分析、投资\n"
    "- 八卦：诉讼纠纷、人事变动（加入/离职/被开除）、公司恩怨、CEO争议言论、"
    "行业撕逼、大佬风波、监管处罚、丑闻\n"
    "关键规则：凡涉及"诉讼/起诉/败诉/胜诉/争议/离职/裁员风波/言论风波"的，"
    "优先归为"八卦"，不管主角是哪家公司。\n"
